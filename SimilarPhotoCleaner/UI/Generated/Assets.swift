...
public enum Assets {
  public enum Colors {
    ...
    public static let buttonTextColor = ColorAsset(name: "buttonTextColor")
    public static let descriptionColor = ColorAsset(name: "descriptionColor")
    public static let primaryBackgroundColor = ColorAsset(name: "primaryBackgroundColor")
    public static let primaryTextColor = ColorAsset(name: "primaryTextColor")
    ...
    public static let selectedTextColor = ColorAsset(name: "selectedTextColor")
    public static let textButtonColor = ColorAsset(name: "textButtonColor")
  }
  public enum Icons {
  ...
  public enum Images {
    public static let completion = ImageAsset(name: "completion")
